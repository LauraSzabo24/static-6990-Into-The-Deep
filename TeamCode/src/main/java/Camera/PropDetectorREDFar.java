...
@Config
public class PropDetectorREDFar extends OpenCvPipeline {
Telemetry telemetry;
Mat mat = new Mat();
...
public static Point leftCorner1 = new Point(20,50);
public static Point leftCorner2 = new Point(90,100);
...
public PropDetectorREDFar(Telemetry t) { telemetry = t; }
